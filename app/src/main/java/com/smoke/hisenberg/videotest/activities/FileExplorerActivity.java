...
package com.smoke.hisenberg.videotest.activities;
...
import com.smoke.hisenberg.videotest.R;
import com.smoke.hisenberg.videotest.application.AppActivity;
import com.smoke.hisenberg.videotest.application.Settings;
import com.smoke.hisenberg.videotest.constant.MyConfig;
import com.smoke.hisenberg.videotest.eventbus.FileExplorerEvents;
import com.smoke.hisenberg.videotest.fragments.FileListFragment;
...
//            doOpenDirectory(getExternalFilesDir(Environment.DIRECTORY_MOVIES).toString(), false);
            doOpenDirectory(MyConfig.baseDirectory, false);
        }
    }
    ...
    public void onClickFile(FileExplorerEvents.OnClickFile event) {
        ...
        try {
            ...
            if (TextUtils.isEmpty(f.toString()))
                f = new File(MyConfig.baseDirectory);
        } catch (IOException e) {
            e.printStackTrace();
        }
